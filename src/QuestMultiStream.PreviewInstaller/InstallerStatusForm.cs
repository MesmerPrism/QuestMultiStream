...
internal sealed class InstallerStatusForm : Form
{
    ...
    private string? _lastArchivePath = Program.GetDownloadedArchivePath();
        ...
        string releasePageUri)
    {
        ...
        Text = "Quest Multi Stream Preview Setup";
        ...
        _retryButton = BuildButton("Open Downloaded Archive", isPrimary: true, AccentColor);
        ...
        _detailLabel = new Label
        {
            ...
            Text = "The bootstrapper downloads the latest portable release, installs it under LocalAppData, and refreshes the shortcuts for Quest Multi Stream."
        };
        ...
        _footerLabel = new Label
        {
            ...
            Margin = new Padding(0),
            MaximumSize = new Size(780, 0),
            Text = "The portable preview includes the scrcpy runtime so the app can cast outside the source repo."
        };
        ...
        _introLabel = new Label
        {
            ...
            Text = "This installer downloads the latest portable Windows preview, installs it under LocalAppData, and launches Quest Multi Stream directly.",
        ...
        _titleLabel = new Label
        {
            ...
            MaximumSize = new Size(800, 0),
            Text = "Install Or Update Quest Multi Stream",
    ...
    private async Task RunInstallAsync()
    {
        ...
        try
        {
            ...
            _footerLabel.Text = "Quest Multi Stream is ready. If Windows does not bring it forward automatically, launch it from the Start menu.";
        ...
        catch (Exception exception)
        {
            ...
            _footerLabel.Text = "If direct install still fails on this machine, open the downloaded archive or fall back to the GitHub releases page for the portable zip.";
            _progressPercent = 0;
            UpdateProgressBarFill();
            _retryButton.Visible = File.Exists(_lastArchivePath);
    ...
    {
        if (string.IsNullOrWhiteSpace(_lastArchivePath) || !File.Exists(_lastArchivePath))
        {
            return;
        }
    ...
    private static Image? LoadEmbeddedLogo()
    {
        ...
        using var stream = assembly.GetManifestResourceStream("QuestMultiStream.PreviewInstaller.Assets.quest-multi-stream.png");
