<#
.SYNOPSIS
    Publishes the guided Quest Multi Stream preview setup bootstrapper.
#>
[CmdletBinding()]
param(
    [ValidateSet('Release')]
    ...
    [string]$FileName = 'QuestMultiStream-Preview-Setup.exe',
...
$projectPath = Join-Path $repoRoot 'src\QuestMultiStream.PreviewInstaller\QuestMultiStream.PreviewInstaller.csproj'
...
$publishedExe = Join-Path $publishPath 'QuestMultiStream.PreviewInstaller.exe'
